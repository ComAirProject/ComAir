...
#include "LoopProfiling/ArraySampleInstrument/ArraySampleInstrument.h"
...
static RegisterPass<ArraySampleInstrument> X("array-list-sample-instrument",
...
char ArraySampleInstrument::ID = 0;
...
void ArraySampleInstrument::getAnalysisUsage(AnalysisUsage &AU) const {
    AU.setPreservesAll();
...
ArraySampleInstrument::ArraySampleInstrument() : ModulePass(ID) {
...
void ArraySampleInstrument::SetupTypes() {
...
void ArraySampleInstrument::SetupConstants() {
...
void ArraySampleInstrument::SetupGlobals() {
...
void ArraySampleInstrument::SetupFunctions() {
...
void ArraySampleInstrument::InstrumentInit(Instruction *firstInst) {
...
void ArraySampleInstrument::InstrumentReturn(Function *pFunction) {
...
void ArraySampleInstrument::MarkFlag(Instruction *Inst) {
...
void ArraySampleInstrument::RemapInstruction(Instruction *I, ValueToValueMapTy &VMap) {
...
void ArraySampleInstrument::InstrumentHooks(Function *pFunction, Instruction *pInst) {
...
void ArraySampleInstrument::CreateIfElseIfBlock(Loop *pInnerLoop, vector<BasicBlock *> &vecAdded) {
...
void ArraySampleInstrument::CloneInnerLoop(Loop *pLoop, vector<BasicBlock *> &vecAdd, ValueToValueMapTy &VMap) {
...
void ArraySampleInstrument::InstrumentCostUpdater(Loop *pLoop) {
...
void ArraySampleInstrument::InstrumentInnerLoop(Loop *pInnerLoop, PostDominatorTree *PDT) {
...
void ArraySampleInstrument::SetupInit(Module &M) {
...
bool ArraySampleInstrument::runOnModule(Module &M) {
    ...
    if (pInst == NULL) {
        errs() << "Could not find Array in target Function!" << "\n";
        exit(0);
    }
