#include "RecursiveSampler/NoRecursiveInstrumentor/NoRecursiveInstrumentor.h"
...
#define DEBUG_TYPE "NoRecursiveInstrumentor"

STATISTIC(no_opt_cost, "No Opt Cost");
STATISTIC(opt_cost, "Opt Cost");

static RegisterPass<NoRecursiveInstrumentor> X(
...
char NoRecursiveInstrumentor::ID = 0;

void NoRecursiveInstrumentor::getAnalysisUsage(AnalysisUsage &AU) const {
    AU.setPreservesAll();
    AU.addRequired<ScalarEvolutionWrapperPass>();
}

NoRecursiveInstrumentor::NoRecursiveInstrumentor() : ModulePass(ID) {
    PassRegistry &Registry = *PassRegistry::getPassRegistry();
    initializeScalarEvolutionWrapperPassPass(Registry);
}

void NoRecursiveInstrumentor::SetupTypes() {
...
void NoRecursiveInstrumentor::SetupStructs() {
...
void NoRecursiveInstrumentor::SetupConstants() {
...
void NoRecursiveInstrumentor::SetupGlobals() {
...
void NoRecursiveInstrumentor::SetupFunctions() {
...
void NoRecursiveInstrumentor::SetupInit(Module &M) {
...
void NoRecursiveInstrumentor::InstrumentMain() {
...
void NoRecursiveInstrumentor::InlineSetRecord(Value *address, Value *length, Value *flag, Instruction *InsertBefore) {
...
//void NoRecursiveInstrumentor::InlineHookDelimit(Instruction *InsertBefore) {
//
//    InlineSetRecord(this->ConstantLong0, this->ConstantInt0, this->ConstantInt1, InsertBefore);
//}

void NoRecursiveInstrumentor::InlineHookLoad(Value *addr, Type *type1, Instruction *InsertBefore) {
...
void NoRecursiveInstrumentor::InlineHookLoad(Value *addr, ConstantInt *const_length, Instruction *InsertBefore) {
...
void NoRecursiveInstrumentor::InlineHookStore(Value *addr, Type *type1, Instruction *InsertBefore) {
...
void NoRecursiveInstrumentor::InlineOutputCost(Instruction *InsertBefore) {
...
bool NoRecursiveInstrumentor::runOnModule(Module &M) {
...
void NoRecursiveInstrumentor::CloneFunctionCalled(set<BasicBlock *> &setBlocksInLoop, ValueToValueMapTy &VCalleeMap,
                                           map<Function *, set<Instruction *> > &FuncCallSiteMapping) {
...
void NoRecursiveInstrumentor::InlineHookMem(MemTransferInst * pMem, Instruction *II) {
...
void NoRecursiveInstrumentor::InlineHookIOFunc(Function *F, Instruction *II) {
...
void NoRecursiveInstrumentor::CreateIfElseBlock(Function *pRecursiveFunc, std::vector<BasicBlock *> &vecAdded, ValueToValueMapTy &VMap) {
...
void NoRecursiveInstrumentor::CreateIfElseIfBlock(Function *pRecursiveFunc, std::vector<BasicBlock *> &vecAdded) {
...
void NoRecursiveInstrumentor::InstrumentReturn(Function *Func) {
...
void NoRecursiveInstrumentor::InstrumentNewReturn(Function *Func) {
...
void NoRecursiveInstrumentor::InstrumentRmsUpdater(Function *F) {
...
void NoRecursiveInstrumentor::CloneRecursiveFunction() {
...
void NoRecursiveInstrumentor::InlineNumGlobalCost(Function *pFunction) {
...
bool
NoRecursiveInstrumentor::SearchToBeInstrumented(Function *pRecursiveFunc, std::vector<Instruction *> &vecToInstrument) {
...
void NoRecursiveInstrumentor::getAliasInstInfo(std::unique_ptr<AliasSetTracker> CurAST, const MonitoredRWInsts &MI,
...
void NoRecursiveInstrumentor::removeByDomInfo(DominatorTree &DT, vector<set<Instruction *>> &vecAI, MonitoredRWInsts &MI) {
...
void NoRecursiveInstrumentor::InstrumentRecursiveFunction(Function *pFunction) {

    InlineGlobalCostForCallee(pFunction);
//    MonitoredRWInsts inplace;
...
//        for (auto &kv : inplace.mapLoadID) {
//            for (auto &kv2 : inplace.mapStoreID) {
...
//            if (inplace.mapStoreID.find(SI) != inplace.mapStoreID.end()) {
//                inplace.mapStoreID.erase(SI);
//            }
//        }
//
////    unique_ptr<AliasSetTracker> CurAST = make_unique<AliasSetTracker>(AA);
////    getAliasInstInfo(std::move(CurAST), inplace, vecAI);
////    removeByDomInfo(DT, vecAI, inplace);
//    errs() << "-" << inplace.size() << "\n";
//    InstrumentMonitoredInsts(inplace);
}
...
void NoRecursiveInstrumentor::InlineHookLoad(LoadInst *pLoad, unsigned uID, Instruction *InsertBefore) {
...
void NoRecursiveInstrumentor::InlineHookStore(StoreInst *pStore, unsigned uID, Instruction *InsertBefore) {
...
void NoRecursiveInstrumentor::InlineHookMemSet(MemSetInst *pMemSet, unsigned uID, Instruction *InsertBefore) {
...
void
NoRecursiveInstrumentor::InlineHookMemTransfer(MemTransferInst *pMemTransfer, unsigned uID, Instruction *InsertBefore) {
...
void NoRecursiveInstrumentor::InlineHookFgetc(Instruction *pCall, unsigned uID, Instruction *InsertBefore) {
...
void NoRecursiveInstrumentor::InlineHookFread(Instruction *pCall, unsigned uID, Instruction *InsertBefore) {
...
void NoRecursiveInstrumentor::InlineHookOstream(Instruction *pCall, unsigned uID, Instruction *InsertBefore) {
...
void NoRecursiveInstrumentor::InstrumentMonitoredInsts(MonitoredRWInsts &MI) {
...
void NoRecursiveInstrumentor::InlineGlobalCostForCallee(Function *pFunction) {
    ...
    unsigned Count = 0;
    bbGraph.instrumentLocalCounterUpdate(numLocalCounter, this->numGlobalCost, &Count);
    opt_cost += Count;
}
...
void NoRecursiveInstrumentor::RemapInstruction(Instruction *I, ValueToValueMapTy &VMap) {
