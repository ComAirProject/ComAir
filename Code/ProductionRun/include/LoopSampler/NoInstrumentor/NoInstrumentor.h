#ifndef NEWCOMAIR_NoINSTRUMENTOR_H
#define NEWCOMAIR_NoINSTRUMENTOR_H
...
struct NoInstrumentor : public ModulePass {
...
private:
    ...
    void getAliasInstInfo(std::unique_ptr<AliasSetTracker> CurAST, const MonitoredRWInsts &MI,
    ...
    void InstrumentCallees(std::set<Function *> setOriginFunc, ValueToValueMapTy &originClonedMapping, DominatorTree &DT, std::shared_ptr<AliasSetTracker> CurAST);
...
#endif //NEWCOMAIR_NoINSTRUMENTOR_H
