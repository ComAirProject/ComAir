...
static RegisterPass<LoopArrayInstrumentor> X("opt-loop-instrument",
...
bool LoopArrayInstrumentor::runOnModule(Module &M)
{
    ...
    std::set<Value *> setArrayValue;
    if (!IsArrayAccessLoop(pLoop, setArrayValue) && !IsArrayAccessLoop1(pLoop, setArrayValue))
    {
        errs() << "Loop is not Array\n";
        return false;
    }

    for (Value *V : setArrayValue)
    {
        if (Instruction *I = dyn_cast<Instruction>(V))
        {
            I->dump();
            errs() << "Stride:" << FindStride(I) << "\n";
        }
    }
...
void LoopArrayInstrumentor::InlineSetRecord(Value *address, Value *length, Value *id, Instruction *InsertBefore)
{
...
void LoopArrayInstrumentor::InlineHookLoad(LoadInst *pLoad, unsigned uID, Instruction *InsertBefore)
{
...
void LoopArrayInstrumentor::InlineHookStore(StoreInst *pStore, unsigned uID, Instruction *InsertBefore)
{
...
void LoopArrayInstrumentor::InlineHookMemSet(MemSetInst *pMemSet, unsigned uID, Instruction *InsertBefore)
{
...
void LoopArrayInstrumentor::InlineHookMemTransfer(MemTransferInst *pMemTransfer, unsigned uID, Instruction *InsertBefore)
{
...
void LoopArrayInstrumentor::InlineHookFgetc(Instruction *pCall, unsigned uID, Instruction *InsertBefore)
{
...
void LoopArrayInstrumentor::InlineHookFread(Instruction *pCall, unsigned uID, Instruction *InsertBefore)
{
...
void LoopArrayInstrumentor::InlineHookOstream(Instruction *pCall, unsigned uID, Instruction *InsertBefore)
{
...
void LoopArrayInstrumentor::InstrumentHoistMonitoredInsts(MonitoredRWInsts &MI, Instruction *InsertBefore)
{
...
void LoopArrayInstrumentor::FindDirectCallees(const std::set<BasicBlock *> &setBB, std::vector<Function *> &vecWorkList,
...
void LoopArrayInstrumentor::FindCalleesInDepth(const std::set<BasicBlock *> &setBB, std::set<Function *> &setToDo,
                                               std::map<Function *, std::set<Instruction *>> &funcCallSiteMapping)
{
...
void LoopArrayInstrumentor::InlineGlobalCostForLoop(std::set<BasicBlock *> &setBBInLoop)
{
