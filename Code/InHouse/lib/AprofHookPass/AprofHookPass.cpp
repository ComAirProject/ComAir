...
namespace Aprof {
    ...
    static RegisterPass<AprofHookPass> X(
            "instrument-hooks",
    ...
    bool static hasCallReturn(BasicBlock *BB) {
    ...
    char AprofHookPass::ID = 0;

    AprofHookPass::AprofHookPass() : ModulePass(ID) {}

    void AprofHookPass::getAnalysisUsage(AnalysisUsage &AU) const {}

    void AprofHookPass::SetupTypes() {
    ...
    void AprofHookPass::SetupConstants() {
    ...
    void AprofHookPass::SetupGlobals() {

    }

    void AprofHookPass::SetupFunctions() {
...
//    assert(this->aprof_return != NULL);
    ...
    void AprofHookPass::InstrumentInit(Instruction *firstInst) {
    ...
    void AprofHookPass::InstrumentCostUpdater(Function *pFunction, bool isOptimized) {
    ...
    void AprofHookPass::InstrumentWrite(StoreInst *pStore, Instruction *BeforeInst) {
...
//        type_1 = type_1->getContainedType(0);
    ...
    void AprofHookPass::InstrumentRead(LoadInst *pLoad, Instruction *BeforeInst) {
...
//        type_1 = type_1->getContainedType(0);
    ...
    void AprofHookPass::InstrumentAlloc(Value *var, Instruction *BeforeInst) {
    ...
    void AprofHookPass::InstrumentCallBefore(Function *F) {
 ...
 */
    void AprofHookPass::InstrumentRmsUpdater(Function *F) {
    ...
    void AprofHookPass::InstrumentRmsUpdater(Function *F, Instruction *BeforeInst) {
    ...
    void AprofHookPass::ProcessMemIntrinsic(MemIntrinsic *memInst) {
    ...
    void AprofHookPass::InstrumentReturn(Instruction *BeforeInst) {
    ...
    void AprofHookPass::InstrumentFinal(Function *mainFunc) {
    ...
    void AprofHookPass::InstrumentHooks(Function *Func, bool isOptimized) {
...
//                }
                    ...
                    case Instruction::Call:case Instruction::Invoke: {
                        ...
                        Instruction *BeforeInst = Inst->getNextNode();
                        if (Callee && Callee->getName() == "_ZStlsIcSt11char_traitsIcESaIcEERSt13basic_ostreamIT_T0_ES7_RKNSt7__cxx1112basic_stringIS4_S5_T1_EE") {
                            DataLayout *dl = new DataLayout(this->pModule);
                            Value *var= ci.getArgument(1);
                            assert(var);

                            Type *type = var->getType();
                            assert(type);
                            Type *type_1 = type->getContainedType(0);
                            assert(type_1);
...
//        }
    ...
    bool AprofHookPass::runOnModule(Module &M) {
