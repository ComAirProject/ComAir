#ifndef PRODUCTIONRUN_ARRAYLINKEDIDENTIFIER_H
#define PRODUCTIONRUN_ARRAYLINKEDIDENTIFIER_H
...
int64_t FindStride(Instruction *ArrayIdx);

#endif //PRODUCTIONRUN_ARRAYLINKEDIDENTIFIER_H
