#ifndef NEWCOMAIR_OPTLOOPINSTRUMENTOR_H
#define NEWCOMAIR_OPTLOOPINSTRUMENTOR_H
...
struct OptLoopInstrumentor : public ModulePass {
...
#endif //NEWCOMAIR_OPTLOOPINSTRUMENTOR_H
