#ifndef NEWCOMAIR_OtherINSTRUMENTOR_H
#define NEWCOMAIR_OtherINSTRUMENTOR_H
...
struct OtherInstrumentor : public ModulePass {
...
private:
    ...
    void getAliasInstInfo(AliasSetTracker &CurAST, const MonitoredRWInsts &MI, vector<set<Instruction *>> &vecAI);
    ...
    void InstrumentCallees(std::set<Function *> setOriginFunc, ValueToValueMapTy &originClonedMapping, DominatorTree &DT, AliasSetTracker& CurAST);
...
#endif //NEWCOMAIR_OtherINSTRUMENTOR_H
