...
struct LoopSampleInstrumentor : public ModulePass
{

    static char ID;

    LoopSampleInstrumentor();
    ...
    void CloneInnerLoop(Loop *pLoop, ValueToValueMapTy &VMap, BasicBlock *&pClonedLoopHeader);
...
private:
    ...
    GlobalVariable *numGlobalSampledCounter;
