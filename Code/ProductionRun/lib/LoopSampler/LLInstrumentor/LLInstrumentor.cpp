 ...
 * Use DSS instead of RMS, which means only record read instructions.
 */

#include "LoopSampler/LLInstrumentor/LLInstrumentor.h"
...
#include "LoopSampler/LLInstrumentor/BBProfiling.h"
...
#define DEBUG_TYPE "LLInstrumentor"

static RegisterPass<LLInstrumentor> X("opt-loop-instrument",
...
LLInstrumentor::LLInstrumentor() : ModulePass(ID) {
...
void LLInstrumentor::getAnalysisUsage(AnalysisUsage &AU) const {
...
bool LLInstrumentor::runOnModule(Module &M) {
...

    {
        ...
        // LL Opt: remove write
        inplaceMI.mapStoreID.clear();
        inplaceMI.mapMemSetID.clear();
        inplaceMI.mapMemTransferID.clear();
    ...
    BasicBlock *pClonedBody = vecCloned[2];
...
void LLInstrumentor::HoistOrSinkMonitoredInsts(MonitoredRWInsts &MI, Instruction *InsertBefore) {
...
void LLInstrumentor::InlineNumGlobalCost(Loop *pLoop, ValueToValueMapTy &VMap) {
...
void LLInstrumentor::getMonitoredRWInsts(const std::set<BasicBlock *> &setBB, MonitoredRWInsts &MI) {
...
void LLInstrumentor::getAliasInstInfo(std::unique_ptr<AliasSetTracker> CurAST, const MonitoredRWInsts &MI,
                                           vector<set<Instruction *>> &vecAI) {
...
void LLInstrumentor::removeByDomInfo(DominatorTree &DT, vector<set<Instruction *>> &vecAI, MonitoredRWInsts &MI) {
...
void LLInstrumentor::InlineGlobalCostForLoop(std::set<BasicBlock *> &setBBInLoop) {
...
void LLInstrumentor::InlineGlobalCostForCallee(Function *pFunction) {
...
void LLInstrumentor::InlineSetRecord(Value *address, Value *length, Value *id, Instruction *InsertBefore) {
...
void LLInstrumentor::InlineHookDelimit(Instruction *InsertBefore) {

    InlineSetRecord(this->ConstantLong0, this->ConstantInt0, this->ConstantDelimit, InsertBefore);
}

void LLInstrumentor::InlineHookLoad(LoadInst *pLoad, unsigned uID, Instruction *InsertBefore) {
...
void LLInstrumentor::InlineHookStore(StoreInst *pStore, unsigned uID, Instruction *InsertBefore) {
...
void LLInstrumentor::InlineHookMemSet(MemSetInst *pMemSet, unsigned uID, Instruction *InsertBefore) {
...
void
LLInstrumentor::InlineHookMemTransfer(MemTransferInst *pMemTransfer, unsigned uID, Instruction *InsertBefore) {
...
void LLInstrumentor::InlineHookFgetc(Instruction *pCall, unsigned uID, Instruction *InsertBefore) {
...
void LLInstrumentor::InlineHookFread(Instruction *pCall, unsigned uID, Instruction *InsertBefore) {
...
void LLInstrumentor::InlineHookOstream(Instruction *pCall, unsigned uID, Instruction *InsertBefore) {
...
void LLInstrumentor::SetupInit(Module &M) {
...
void LLInstrumentor::SetupTypes() {
...
void LLInstrumentor::SetupStructs() {
...
void LLInstrumentor::SetupConstants() {
...
void LLInstrumentor::SetupGlobals() {
...
void LLInstrumentor::SetupFunctions() {
...
bool LLInstrumentor::CloneRemapCallees(const std::set<BasicBlock *> &setBB, std::set<Function *> &setCallee,
...
void LLInstrumentor::FindDirectCallees(const std::set<BasicBlock *> &setBB, std::vector<Function *> &vecWorkList,
...
void LLInstrumentor::FindCalleesInDepth(const std::set<BasicBlock *> &setBB, std::set<Function *> &setToDo,
                                             std::map<Function *, std::set<Instruction *>> &funcCallSiteMapping) {
...
void LLInstrumentor::CloneFunctions(std::set<Function *> &setFunc, ValueToValueMapTy &originClonedMapping) {
...
bool LLInstrumentor::RemapFunctionCalls(const std::set<Function *> &setFunc,
                                             std::map<Function *, std::set<Instruction *>> &funcCallSiteMapping,
                                             ValueToValueMapTy &originClonedMapping) {
...
void LLInstrumentor::InstrumentMain(StringRef funcName) {
...
void LLInstrumentor::InlineOutputCost(Instruction *InsertBefore) {
...
void LLInstrumentor::InstrumentMonitoredInsts(MonitoredRWInsts &MI) {
...
void
LLInstrumentor::InstrumentCallees(std::set<Function *> setOriginFunc, ValueToValueMapTy &originClonedMapping) {
...
void LLInstrumentor::CreateIfElseBlock(Loop *pInnerLoop, vector<BasicBlock *> &vecAdded) {
    /*
...
//void LLInstrumentor::CreateIfElseIfBlock(Loop *pInnerLoop, vector<BasicBlock *> &vecAdded) {
//    /*
...
void LLInstrumentor::CloneInnerLoop(Loop *pLoop, vector<BasicBlock *> &vecAdd, ValueToValueMapTy &VMap,
                                         vector<BasicBlock *> &vecCloned) {
...
void LLInstrumentor::RemapInstruction(Instruction *I, ValueToValueMapTy &VMap) {
...
void LLInstrumentor::getInstsToBeHoisted(Loop *pLoop, AliasAnalysis &AA, MonitoredRWInsts &inplaceMI,
                                              MonitoredRWInsts &hoistMI) {
...
bool LLInstrumentor::cloneDependantInsts(Loop *pLoop, Instruction *pInst, Instruction *InsertBefore,
...
bool LLInstrumentor::sinkInstsToLoopExit(Loop *pLoop, Instruction *pInst, Instruction *InsertBefore,
                                              ValueToValueMapTy &VMap) {
...
void LLInstrumentor::insertBeforeExitLoop(Loop *pLoop, DominatorTree &DT, ValueToValueMapTy &VMap,
