#include "LoopSampler/OtherInstrumentor/OtherInstrumentor.h"
...
#include <LoopSampler/OtherInstrumentor/BBProfiling.h>
...
#define DEBUG_TYPE "OtherLoopInstrumentor"

static RegisterPass<OtherInstrumentor> X("opt-loop-instrument",
...
char OtherInstrumentor::ID = 0;

OtherInstrumentor::OtherInstrumentor() : ModulePass(ID) {
...
void OtherInstrumentor::getAnalysisUsage(AnalysisUsage &AU) const {
...
bool OtherInstrumentor::runOnModule(Module &M) {
    ...
    InstrumentCallees(setCallees, VCalleeMap, DT, CurAST);
...
//        getAliasInstInfo(CurAST, inplaceMI, vecAI);
...
void OtherInstrumentor::InlineNumGlobalCost(Loop *pLoop) {
...
void OtherInstrumentor::getMonitoredRWInsts(const std::set<BasicBlock *> &setBB, MonitoredRWInsts &MI) {
...
void OtherInstrumentor::getAliasInstInfo(AliasSetTracker& CurAST, const MonitoredRWInsts &MI,
                                           vector<set<Instruction *>> &vecAI) {
...
void OtherInstrumentor::removeByDomInfo(DominatorTree &DT, vector<set<Instruction *>> &vecAI, MonitoredRWInsts &MI) {
...
void OtherInstrumentor::InlineGlobalCostForLoop(std::set<BasicBlock *> &setBBInLoop) {
...
void OtherInstrumentor::InlineGlobalCostForCallee(Function *pFunction) {
    ...
    std::set<BasicBlock *> setBBInFunc;
    for (BasicBlock &BB : *pFunction) {
        setBBInFunc.insert(&BB);
    }

    for (BasicBlock *BB : setBBInFunc) {
//        no_opt_cost++;
        Instruction *pTerm = BB->getTerminator();
        auto pLoad = new LoadInst(this->numGlobalCost, "numGlobalCost", pTerm);
        BinaryOperator *pBinary = BinaryOperator::Create(Instruction::Add, pLoad, this->ConstantLong1, "numGlobalCost++",
...
void OtherInstrumentor::InlineSetRecord(Value *address, Value *length, Value *id, Instruction *InsertBefore) {
...
void OtherInstrumentor::InlineHookDelimit(Instruction *InsertBefore) {

    InlineSetRecord(this->ConstantLong0, this->ConstantInt0, this->ConstantDelimit, InsertBefore);
}

void OtherInstrumentor::InlineHookLoad(LoadInst *pLoad, unsigned uID, Instruction *InsertBefore) {
...
void OtherInstrumentor::InlineHookStore(StoreInst *pStore, unsigned uID, Instruction *InsertBefore) {
...
void OtherInstrumentor::InlineHookMemSet(MemSetInst *pMemSet, unsigned uID, Instruction *InsertBefore) {
...
void
OtherInstrumentor::InlineHookMemTransfer(MemTransferInst *pMemTransfer, unsigned uID, Instruction *InsertBefore) {
...
void OtherInstrumentor::InlineHookFgetc(Instruction *pCall, unsigned uID, Instruction *InsertBefore) {
...
void OtherInstrumentor::InlineHookFread(Instruction *pCall, unsigned uID, Instruction *InsertBefore) {
...
void OtherInstrumentor::InlineHookOstream(Instruction *pCall, unsigned uID, Instruction *InsertBefore) {
...
void OtherInstrumentor::SetupInit(Module &M) {
...
void OtherInstrumentor::SetupTypes() {
...
void OtherInstrumentor::SetupStructs() {
...
void OtherInstrumentor::SetupConstants() {
...
void OtherInstrumentor::SetupGlobals() {
...
void OtherInstrumentor::SetupFunctions() {
...
bool OtherInstrumentor::CloneRemapCallees(const std::set<BasicBlock *> &setBB, std::set<Function *> &setCallee,
...
void OtherInstrumentor::FindDirectCallees(const std::set<BasicBlock *> &setBB, std::vector<Function *> &vecWorkList,
...
void OtherInstrumentor::FindCalleesInDepth(const std::set<BasicBlock *> &setBB, std::set<Function *> &setToDo,
                                             std::map<Function *, std::set<Instruction *>> &funcCallSiteMapping) {
...
void OtherInstrumentor::CloneFunctions(std::set<Function *> &setFunc, ValueToValueMapTy &originClonedMapping) {
...
bool OtherInstrumentor::RemapFunctionCalls(const std::set<Function *> &setFunc,
                                             std::map<Function *, std::set<Instruction *>> &funcCallSiteMapping,
                                             ValueToValueMapTy &originClonedMapping) {
...
void OtherInstrumentor::InstrumentMain(StringRef funcName) {
...
void OtherInstrumentor::InlineOutputCost(Instruction *InsertBefore) {
...
void OtherInstrumentor::InstrumentMonitoredInsts(MonitoredRWInsts &MI) {
...
void OtherInstrumentor::HoistOrSinkMonitoredInsts(MonitoredRWInsts &MI, Instruction *InsertBefore) {
...
void
OtherInstrumentor::InstrumentCallees(std::set<Function *> setOriginFunc, ValueToValueMapTy &originClonedMapping, DominatorTree &DT, AliasSetTracker& CurAST) {
...
//        {
//            vector<set<Instruction *>> vecAI;
//            getAliasInstInfo(CurAST, MI, vecAI);
...
void OtherInstrumentor::CreateIfElseBlock(Loop *pInnerLoop, vector<BasicBlock *> &vecAdded) {
    /*
...
void OtherInstrumentor::CreateIfElseIfBlock(Loop *pInnerLoop, vector<BasicBlock *> &vecAdded) {
    /*
...
void OtherInstrumentor::CloneInnerLoop(Loop *pLoop, vector<BasicBlock *> &vecAdd, ValueToValueMapTy &VMap,
                                         vector<BasicBlock *> &vecCloned) {
...
void OtherInstrumentor::RemapInstruction(Instruction *I, ValueToValueMapTy &VMap) {
...
void OtherInstrumentor::getInstsToBeHoisted(Loop *pLoop, AliasAnalysis &AA, MonitoredRWInsts &inplaceMI,
                                              MonitoredRWInsts &hoistMI) {
...
bool OtherInstrumentor::cloneDependantInsts(Loop *pLoop, Instruction *pInst, Instruction *InsertBefore,
...
bool OtherInstrumentor::sinkInstsToLoopExit(Loop *pLoop, Instruction *pInst, Instruction *InsertBefore,
                                              ValueToValueMapTy &VMap) {
...
void OtherInstrumentor::insertBeforeExitLoop(Loop *pLoop, DominatorTree &DT, ValueToValueMapTy &VMap,
