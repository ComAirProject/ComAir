#ifndef NEWCOMAIR_NORECURSIVEINSTRUMENTOR_H
#define NEWCOMAIR_NORECURSIVEINSTRUMENTOR_H
...
struct NoRecursiveInstrumentor : public ModulePass {

    static char ID;

    NoRecursiveInstrumentor();
...
#endif //NEWCOMAIR_NORECURSIVEINSTRUMENTOR_H
